...
void gigasecondTests() {
  test("date only specification of time", () {
    final DateTime birthDate =
        new DateTime.utc(2011, polyfill.DateTime.april, 25);
  ...
  test("second test for date only specification of time", () {
    final DateTime birthDate =
        new DateTime.utc(1977, polyfill.DateTime.june, 13);
    final DateTime result = add(birthDate);
    DateTime expectedDate =
  ...
  test("third test for date only specification of time", () {
    final DateTime birthDate =
        new DateTime.utc(1959, polyfill.DateTime.july, 19);
    final DateTime result = add(birthDate);
    DateTime expectedDate =
  ...
  test("full time specified", () {
    final DateTime birthDate =
        new DateTime.utc(2015, polyfill.DateTime.january, 24, 22, 00, 00);
    final DateTime result = add(birthDate);
    DateTime expectedDate =
  ...
  test("full time with day roll-over", () {
    final DateTime birthDate =
        new DateTime.utc(2015, polyfill.DateTime.january, 24, 23, 59, 59);
    final DateTime result = add(birthDate);
    DateTime expectedDate =
